...
define gui.text_font = "advent-pro-v20-cyrillic_cyrillic-ext_latin-500.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "advent-pro-v20-cyrillic_cyrillic-ext_latin-800.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "advent-pro-v20-cyrillic_latin-regular.ttf"
