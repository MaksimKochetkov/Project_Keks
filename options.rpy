...
define config.name = _("Project Keks")
...
define gui.about = _p("""
С момента окончания колледжа прошло много лет.

Я давно не видела не только одногрупников, но и родителей.
Конечно, я ведь живу в другом городе.
Теперь я устроилась на кое-какую работу.

Этот день мог не слишком сильно отличиться от любых других.
Да, я вливаюсь в новый коллектив,
но это всё равно не сравнится с прошлыми, в том числе с колледжевскими друзьями.
Даже не смотря на это, именно сегодня начинается эта причудливая история.
""")
...
define config.save_directory = "ProjectKeks-1681288297"
