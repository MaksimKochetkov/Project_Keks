...
label start:
    ...
    mu "Но зачем?"
    d "Так-так. И кто это тут у нас залез в кабинет?"

    show director at right

    mu "А я.. Я просто подрабатываю уборщицей. Убираю гнусные планы!"
    d "Какие такие планы? Разъясни подробнее."
    ...
    d "Ладно. Раз ты так заговорила, а я не успел тебе указать, где твоё место, давай я тебе задам один вопрос."
    d "Какой план изображён на этом листке?"
    d "Обьясни мне по пунктам, что я буду делать?"
    ...
    d "Я вам не рекомендую ходить вокруг да около. В чём суть плана."
    mu "............."
    mu "Вы... Подключаете трубы к головам людей. На первом слайде."
    d "Интересно. Сначала достройте свой план до конца, и только потом я уже разрушу его формулировку. Но вы продолжайте."

    scene letter with fade

    mu "Зачёркнутый кот. Вы явно что-то хотите сделать с котами! Ведь так!"
    d "Я дам свой комментарий только когда вы расскажете мне про все 4 пункта."
    mu "Угрх..."
    ...
    d "Да уж, как и следовало ожидать. Вы абсолютно перевернули план с ног на голову."
    d "Хотя чего ждать от милой кошечки. Твоя работа быть милой, а не умной"
    d "И с этой работой ты справляешься на пять с плюсом. Я благодарю тебя за твою блестящую работу!"
    d "А теперь давай я тебе поясню, как всё было на самом деле"
    d "1 пункт. День хотдогов. Сосисочные шляпы. Видишь, на ней даже нарисована горчица."
    d "Вы, коты, точно любите сосиски. По крайней мере хотдоги без булочек и соусов. То есть обычные сосиски. Не важно."
    mu "А если я кот-веган?"
    d "Ты сама понимаешь, такого не бывает."
    d "2 пункт. Коты зачёркнуты, потому что они любят бегать по городу. Особенно в офисных района. Надо их поймать и отдать в приюты."
    d "Анти котовая акция."
    d "3 пункт..."
    d "Ох, вы меня раскрыли. Да, я хотел провести социальный эксперимент, сколько бы такое шоу набрало просмотров? Лишние деньги с ютуба не помешают."
    d "Но"
    return
